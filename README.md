# Source code and full experiments resutls in "Counterfactual explanations with the k-Nearest Neighborhood classifier and uncertain data"
...
### Folders
- **Experiment_1/**  
  Contains the `.py` files to perform the Experiment 1 detailed in Section 5.1. The subfolders contain the results obtained for different parameters setting. 
- **Experiment_2/**  
  Contains the `.py` files to perform the Experiment 2 detailed in Section 5.2. The subfolders contain the results obtained for different parameters setting.

- **Experiment_3/**  
  Contains the `.py` files to perform the Experiment 3 detailed in Section 5.3. The subfolders contain the results obtained for different datasets.
